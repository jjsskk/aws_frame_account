...
class _DetailCommentPageState extends State<DetailCommentPage> {
  ...
  void initState() {
    ...
    gql
        ...
        .then((value) {
      print(value);
      commentTtitle = value.TITLE;
      comentContent = value.CONTENT;
      user = value.USERNAME;
      date = value.createdAt.toString().substring(0, 10);
              ...
              child: Column(
                children: [
                  ...
                  NewMessage(
                    ...
                    writer: appState.protectorName,
                    email: appState.protectorEmail,
                  ),
                ],
              ),
            ),
    ...
    return _conversations.map((value) {
      return Card(
        child: ListTile(
          ...
          trailing: appState.protectorEmail == value['email']
              ? IconButton(
                  onPressed: () {
                    showDialog(
                        context: context,
