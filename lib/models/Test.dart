...
class Test extends amplify_core.Model {
  ...
  static final amplify_core.QueryModelIdentifier<TestModelIdentifier> MODEL_IDENTIFIER = amplify_core.QueryModelIdentifier<TestModelIdentifier>();
...
class _TestModelType extends amplify_core.ModelType<Test> {
 ...
 */
class TestModelIdentifier implements amplify_core.ModelIdentifier<Test> {
  final String id;
