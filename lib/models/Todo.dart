...
class Todo extends Model {
  ...
  const Todo._internal({required this.id, required isComplete, description, name, createdAt, updatedAt}): _isComplete = isComplete, _description = description, _name = name, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Todo({String? id, required bool isComplete, String? description, String? name}) {
  ...
  Todo copyWith({bool? isComplete, String? description, String? name}) {
    return Todo._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'isComplete': _isComplete, 'description': _description, 'name': _name, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  
  Map<String, Object?> toMap() => {
    'id': id, 'isComplete': _isComplete, 'description': _description, 'name': _name, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };
